                        ...
                        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                            <div class='max-w-md mx-auto space-y-6'>
                                ...
                                <form action="{{route('answer.store',['application'=>$application->id])}}" method="POST">
                                    ...
                                    <textarea name="body" required class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" rows="5">{{old('msgfmt_parse_message')}}</textarea>
                                    <div class="flex items-center justify-end gap-3">
                                        <a href="{{route('dashboard')}}" class="py-3 px-6 my-2 bg-red-500 text-white font-medium rounded cursor-pointer ease-in-out duration-300">Cancel</a>
