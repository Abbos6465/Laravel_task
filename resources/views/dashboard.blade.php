                        ...
                        <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
                            <div class="flex w-full items-center justify-between border-b pb-3">
                                ...
                                <div class="flex items-center space-x-8">
                                    <button class="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold">5</button>
                            ...
                            <div class='max-w-md mx-auto space-y-6'>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <label class="uppercase text-sm font-bold opacity-70">Message</label>
                                        <textarea name="" id="" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" rows="5"></textarea>
                                        <label class="uppercase text-sm font-bold opacity-70">Subject</label>
